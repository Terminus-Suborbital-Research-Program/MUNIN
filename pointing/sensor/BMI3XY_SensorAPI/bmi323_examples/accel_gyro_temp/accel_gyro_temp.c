...
//                     acc_x = lsb_to_g(sensor_data[0].sens_data.acc.x, 2.0f, dev.resolution);
//                     acc_y = lsb_to_g(sensor_data[0].sens_data.acc.y, 2.0f, dev.resolution);
//                     acc_z = lsb_to_g(sensor_data[0].sens_data.acc.z, 2.0f, dev.resolution);

//                     /* Converting lsb to degree per second for 16 bit gyro at 2000dps range. */
//                     gyr_x = lsb_to_dps(sensor_data[1].sens_data.gyr.x, (float)2000, dev.resolution);
//                     gyr_y = lsb_to_dps(sensor_data[1].sens_data.gyr.y, (float)2000, dev.resolution);
//                     gyr_z = lsb_to_dps(sensor_data[1].sens_data.gyr.z, (float)2000, dev.resolution);
